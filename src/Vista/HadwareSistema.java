...
public class HadwareSistema extends JFrame{
    ...
    public HadwareSistema(String rol, String nombre, String apellido, String username, String dni, String telefono, String email) {
        ...
        actualizar_ajustes_BTN.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (!"".equals(ruc_ajustes_TF.getText()) || !"".equals(nom_ajustes_TF.getText()) || !"".equals(telf_ajustes_TF.getText()) || !"".equals(direc_ajustes_TF.getText())) {
                    ajustes.setCuit_sucursal(ruc_ajustes_TF.getText());
                    ajustes.setNom_sucursal(nom_ajustes_TF.getText());
                    ajustes.setTelf_sucursal(telf_ajustes_TF.getText());
                    ajustes.setDirec_sucursal(direc_ajustes_TF.getText());
                    ajustes.setMensaje_sucursal(mensaje_ajustes_TF.getText());
            ...
            public void actionPerformed(ActionEvent e) {
                if ("".equals(ruc_prov_TF.getText())) {
                    ...
                    if (!"".equals(ruc_prov_TF.getText()) || !"".equals(nom_prov_TF.getText()) || !"".equals(telf_prov_TF.getText()) || !"".equals(direc_prov_TF.getText())) {
                        proveedores.setCuit(ruc_prov_TF.getText());
    ...
    public void verTablaProveedores() {
        ...
        for (int i = 0; i < verProveedores.size(); i++) {
            ob[0] = verProveedores.get(i).getCuit();
    ...
    public void verTablaAjustes () {
        ...
        ruc_ajustes_TF.setText("" + ajustes.getCuit_sucursal());
        nom_ajustes_TF.setText("" + ajustes.getNom_sucursal());
        telf_ajustes_TF.setText("" + ajustes.getTelf_sucursal());
        direc_ajustes_TF.setText("" + ajustes.getDirec_sucursal());
        mensaje_ajustes_TF.setText("" + ajustes.getMensaje_sucursal());
    }
